...
- **Sol Stage 1:** post-run raw observation is **96/52** after a 5-hour reset. The reset prevents a direct 5-hour delta from the prior 55% baseline. Weekly raw movement from the previous snapshot is -1 pp. Exact Sol usage remains unresolved.
