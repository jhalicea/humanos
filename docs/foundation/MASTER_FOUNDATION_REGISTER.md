...
| HIST-GOV-BRANCHES-v0.1 | Constitutional Branches, Review Court, and Governance Runtime Charter v0.1 | Historical governance charter; not a ratified constitutional amendment | IMPORTED / PREFLIGHT | Manual governance design; automated governance not established by this register | VERIFIED_SOURCE | Existing charter already defines legislative, executive, judicial/review, investigation, and meta-investigation functions. Future local governance work must reconcile this source rather than create a competing branch model. |
...
1. Owner review of HD-0100 candidate and its HOS-DOC-001 preflight/verification record; keep it unratified unless explicitly approved.
2. Reconcile the historical Constitutional Branches / Review Court charter into the local-first control plane rather than creating a duplicate government standard.
3. Reconcile historical Founding Constitution v0.2 against HF-0200 reconstruction candidate.
4. Reconcile HW-0300 content and historical state.
5. Reconcile HE-0400 content and historical state.
...
### Completed reconciliation in this slice

The August artifact/document governance standards were inspected and treated as source/subordinate control lineage for HD-0100 rather than duplicated as competing standards. HD-0100 remains a candidate orchestration Instrument; it does not silently supersede those historical sources.
